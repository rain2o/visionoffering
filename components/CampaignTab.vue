		...
		<div class="grid grid-cols-12 gap-4">
			...
			<div class="col-span-12 pt-10">
				...
				<p class="pt-5">Together, we will Financially Bless a variety of local and global
					...
					giving to the Cooperative Program, which is a ministry of over 50,000 Baptist churches that
					cooperate in planting churches overseas, training pastors in seminaries, planting churches in the
					largest cities in America, and providing Disaster Relief when tragedies occur. </p>

				<h4 class="capitalize text-xl pt-10 font-bold">Global Outreach</h4>
				<p class="pt-2">We want to continue to send our own partners to Africa to serve the people
					of Zambia this year. Additionally, we want to continue to support Vapor Ministries, an organization
...
<!--				<img
				...
				<p class="pt-5">Our primary need at our Maryville Location is space for parking. We consistently fill our parking lot, which makes it difficult to have space to welcome guests to FC. </p>
				<p class="pt-5">We are so thankful that every week, hundreds of people park in our overflow lots next door in order to open up spaces for the new people God is bringing to our church.  We believe the cost would be at least $600,000 to acquire land for additional parking in Maryville.</p>
				<p class="pt-5">More land will provide parking, but it could also allow us to meet a huge need in our community for our counseling ministry. Hundreds of counseling sessions happen at FC every month, and we dream of one day being able to build a physical counseling center, which is a future goal that we are asking God to provide. </p>
				<p class="pt-5">At this point, God hasn’t revealed the opportunity to buy land, but we believe God will answer in His timing.</p>
			</div>
		</div>
...
<!--			<img
				...
				class="rounded-md shadow-2xl"
			>-->
			<h3 class="uppercase bold text-2xl pt-10 font-bold">Goal 3 - Header Image: Focus On The Theme “expand” ($1,000,000)</h3>
			<h4 class="capitalize text-xl pt-10 font-bold">One Church in two locations</h4>
			<p class="pt-5">We started our Knoxville location 2 years ago, and in this last year, we renovated a movie theater in Knoxville to be the new home for our Knoxville Location.  We’re experiencing record numbers of baptisms, attendance, and first-time guests every week.</p>
			<p class="pt-5">Our first Phase of the renovation gave us the ability to move in and use the space, but we are far from finished. In order to further expand, we need to take the next step for our Knoxville Location by renovating the space for an auditorium and suitable kids' spaces to meet the needs of a growing church. We believe the cost of this project would be $1,000,000.</p>
		</div>

		<div class="col-span-12">
			<p class="text-xl pt-5 pb-3">God gives the mission. Our elders set the vision. But you get to decide if we
				can
				take our
